...
public class Fachada extends UnicastRemoteObject implements IFachada  
{
	...
	private static IFachada objeto=null;
	
	
	// Constructor
	private Fachada() throws RemoteException, ClassNotFoundException{
		//jugadores = new DiccionarioJugadores();//Preguntar la primera vez
		try {
			jugadores = Persistencia.recuperar("respaldar.dat");
		}
	...
	public static IFachada getInstance() throws RemoteException, ClassNotFoundException, PersistenciaException
	{
		if(objeto==null)
		{
			objeto=new Fachada();
	...
	{
		Persistencia.respaldar("respaldar.dat", jugadores);
	}
